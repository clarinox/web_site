...
<div class="container">
 <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12 nopadding">
        <div class="contact_form_bx">
            <div class="inner">
                <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12 nopadding">
<ul class="contact_tabs" role="tablist">
<li class="active"><a href="#enquiry"  role="tab" data-toggle="tab">Enquiry</a></li>
<li><a href="#requestsupport"  role="tab" data-toggle="tab">Request Support</a></li>
<li><a href="#newsletter"  role="tab" data-toggle="tab">Newsletter</a></li>
<li><a href="#unsubscribe"  role="tab" data-toggle="tab">Unsubscribe</a></li>
</ul>
<div class="tab-content">
<div class="tab-pane fade active in" id="enquiry">
...
<input type="text" class="form-control" id="company_name" required data-validation-required-message="Company Name" autocomplete="off">
<p class="help-block text-danger"></p>
</div>
<div class="form-group">
  <label for="sel1">Country</label>
  <select class="form-control" id="country">
<option style="display:none;" value="" disabled selected>Select your country</option>
...
<button type="submit" class="cont_sub_btt"/>
Submit Enquiry
</button>
</div>
</form>
...
<div class="tab-pane fade in" id="requestsupport">
<div class="form_content">
<div class="clearfix">&nbsp;</div>
<p class="form_title">Need assistance with any of our products? If so, then complete the form below.</p>
<p>If you wish to make a general or product inquiry, refer to our Inquiry form.</p>
<form id="requestsupport">
<div class="row">
<div class="col-xs-12 col-sm-6">
<div class="form-group">
<label>First Name<span class="req">*</span> </label>
...
<div class="form-group">
<label for="sel2">Products</label>
      <select multiple class="form-control" id="sel2">
        <option>ClarinoxBlue</option>
        <option>ClarinoxWiFI</option>
        <option>ClariFi</option>
        <option>Koala EVM</option>
        <option>Koala Connect</option>
      <option>Joeyduino</option>
<option>Other</option>
</select>
    </div>
<div class="form-group">
...
<option selected="65535">Select your industry</option> <option value="Accounting">Accounting</option> <option value="Agriculture">Agriculture</option> <option value="Architecture/Design">Architecture/Design</option> <option value="Arts/Entertainment">Arts/Entertainment</option> <option value="Computers - Hardware">Computers - Hardware</option> <option value="Computers - Software">Computers - Software</option> <option value="Consulting">Consulting</option> <option value="Education">Education</option> <option value="Energy/Chemical">Energy/Chemical</option> <option value="Engineering">Engineering</option> <option value="Finance/Banking">Finance/Banking</option> <option value="Government">Government</option> <option value="Health care/Hospital">Health care/Hospital</option> <option value="Information Management/Library">Information Management/Library</option> <option value="Insurance">Insurance</option> <option value="Legal">Legal</option> <option value="Manufacturing">Manufacturing</option> <option value="Marketing/Communications">Marketing/Communications</option> <option value="Media/Broadcasting">Media/Broadcasting</option> <option value="Military">Military</option> <option value="Non-profit/Associations">Non-profit/Associations</option> <option value="Pharmaceutical ">Pharmaceutical</option> <option value="Real Estate/Property Management">Real Estate/Property Management</option> <option value="Human Resource">Human Resource</option> <option value="Research &amp; Development">Research &amp; Development</option> <option value="Retail">Retail</option> <option value="Telecommunication">Telecommunication</option> <option value="Transportation">Transportation</option> <option value="Travel service">Travel service</option> <option value="Student">Student</option> <option value="Others">Others</option></select>
</div>
<div class="form-group">
<label>Phone Number<span class="req">*</span> </label>
<input type="tel" class="form-control" id="phone" required data-validation-required-message="Please enter your phone number." autocomplete="off">
...
<div class="tab-pane fade in" id="unsubscribe">
<div class="form_content">
<form id="unsubscribe">
<div class="form-group">
<label>Email Address<span class="req">*</span> </label>
