...
<div class="container">
    ...
    $session->sent = false;
            ...
            <?php endif;?>﻿﻿
                          ...
                          <form id="contact-form" name="contact-form" accept-charset="UNKNOWN" enctype="application/x-www-form-urlencoded" method="post" action="http://intranet.clarinox.com/clarinox-news/pw_unsubscribe.jsp">
                                ...
                                <div class="form-group cont_fm">
                                    ...
                                    <div class="col-sm-9 col-xs-12">
                                        <button type="submit" class="cont_sub_btt">Submit Unsubscribe Request</button>
                                    </div>
                                </div>
                            </form>
                        </div>
