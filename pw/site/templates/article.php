...
<?php if (($page->name == "the-true-cost-of-free-bluetooth") OR ($page->name == "thank-you")) { ?>
    <script>
        gtag('event', 'conversion', {'send_to': 'AW-369351956/J2sZCIet0sgCEJS6j7AB'});
    </script> 
<?php } ?>
...
<?php if($page->name == "the-true-cost-of-free-bluetooth") { ?>

<!-- Layout for Campaign artice --->

<div class="container">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="col-md-12 col-lg-12 col-sm-12 page_cont col-xs-12">
             <h1 class="page_heading theme_color">Bluetooth Development Made Easier</h1> 
        </div>
        ...
        <div class="col-md-5 col-lg-5 col-sm-5 page_cont col-xs-5 page_foot" >
            <p>
            ...
            <?php endif;?></p>
             <p class="bold theme_color" style="padding-top: 25px;padding-bottom: 25px;"><b>Get it today!</b></p>
             <form id="contact-form" name="contact-form" method="post" action="./" >
                <div class="form-group cont_fm">
                    <label class="col-sm-3  control-label" for="Name">Name</label>
                    <div class="col-sm-9 col-xs-12">
                        <input id="Name" class="form-control" type="name" name="full_name" placeholder="Name " value="<?php echo ($input->post->full_name) ?>" required>
                    </div>
                </div>
                <div class="form-group cont_fm">
                ...
                <div class="form-group cont_fm">
                    <label class="col-sm-3  control-label" for="First Name">Company</label>
                    <div class="col-sm-9 col-xs-12">
                        <input id="Company Name" class="form-control" type="text" name="company" placeholder="Company Name " value="<?php echo ($input->post->company) ?>" required>
                    </div>
                </div>
                <div class="form-group cont_fm">
                ...
                <div class="form-group cont_fm">
                    ...
                    <div class="col-sm-9 col-xs-12">
                        ...
                        <button type="submit" class="cont_sub_btt">Get it now</button>
...
<?php } elseif ($page->name == "thank-you") { 
    $clxInternal = $session->get('clxInternal');
?>

<!-- Thank You page -->
<?php if ($clxInternal == 'y8Iz4gutTnS5j0TAYg1c') {?>
<div class="container">
...
<div class="container">
    <div class="col-md-12 col-sm-12 col-xs-12 nopadding">
        <div class="col-md-12 col-lg-12 col-sm-12 page_cont col-xs-12 nopadding">
            <h3 class="page_heading theme_color">Please Register</h3> 
        </div>
        <div class="col-md-12 col-lg-12 col-sm-12 page_cont col-xs-12 nopadding">
        <p>Please register first <a href="/resources/articles/managers/the-true-cost-of-free-bluetooth">here</a> to download the article</p>
        </div>
    </div>
</div>
<?php } ?>
...
<div class="container">
    <div class="col-md-12 col-sm-12 col-xs-12 nopadding">
        ...
        <div class="col-md-12 col-lg-12 col-sm-12 page_cont col-xs-12 nopadding">
            ...
            <?php $file = $page->files->first();  ?>
            <?php if ($page->files->count()) { ?>
                <p><a class="btn" href='<?php echo $file->url ?>'>Get the PDF today</a></p>
            <?php } ?> 
        </div>
    </div>
</div>
