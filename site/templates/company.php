...
<head>
    ...
    <title>Clarinox | an embedded wireless protocol stack software company</title><link rel="canonical" href="/company/">
...
<div id="bootstrap-touch-slider" class="carousel bs-slider fade  company_pg_slide control-round indicators-line" data-ride="carousel" data-pause="hover" data-interval="false" >
    ...
    <!-- Wrapper For Slides -->
    <div class="carousel-inner com-top" role="listbox">
        <?php
...
<div class="container">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12 nopadding product_list">
        ...
        <div class="col-md-9 col-sm-8 col-xs-12">
            <div class=" col-md-12 col-sm-12 col-xs-12 nopadding">
                   <div class="product_cont_bx logo-bx">
             <div class="slider company_grayscale responsive movs">
