...
<head>
    ...
    <title>Embedded systems and Embedded Wireless hardware | Clarinox</title><link rel="canonical" href="/products/hardware/">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12 nopadding product_list">
        <div class="col-md-3 col-sm-4 col-xs-12">
            <div class="product_left company_left">
                ...
                <a href="/products/hardware/"style="color:white"target="blank">  Koala Connect</a>
                </span>
                </div>
            </div>
        </div>
